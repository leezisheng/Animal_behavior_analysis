...
root_dir = "F:\\Animal_behavior_analysis\\Dataset\\video_dataset\\03"
...
if __name__ == "__main__":
    ...
    for item in os.listdir(root_dir):
        ...
        video_path = os.path.join(full_path, video_name+".mp4")
        video_label_path = os.path.join(full_path, video_name + "_gt.txt")
